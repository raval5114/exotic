...
class ProductModel {
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'p_type': pType,
      'p_hsncode': pHsncode,
      'p_hsncode_details': pHsncodeDetails,
      'p_first_c_id': pFirstCId,
      'p_second_c_id': pSecondCId,
      'p_third_c_id': pThirdCId,
      'p_four_c_id': pFourCId,
      'p_five_c_id': pFiveCId,
      'p_six_c_id': pSixCId,
      'p_seven_c_id': pSevenCId,
      'p_brand_id': pBrandId,
      'p_short_desc': pShortDesc,
      'p_desc': pDesc,
      'p_unit_price': pUnitPrice,
      'p_discount_price': pDiscountPrice,
      'p_discount_type': pDiscountType,
      'p_selling_price': pSellingPrice,
      'p_qty': pQty,
      'p_weight': pWeight,
      'p_length': pLength,
      'p_width': pWidth,
      'p_height': pHeight,
      'p_net_qty': pNetQty,
      'p_max_product_by_per_order': pMaxProductByPerOrder,
      'p_pack_weight': pPackWeight,
      'p_pack_length': pPackLength,
      'p_pack_width': pPackWidth,
      'p_pack_height': pPackHeight,
      'p_pack_volume': pPackVolume,
      'p_man_desc': pManDesc,
      'p_pack_desc': pPackDesc,
      'p_tags': pTags,
      'p_sku': pSku,
      'p_todays_deal': pTodaysDeal,
      'p_flash_deal': pFlashDeal,
      'p_main_image': pMainImage,
      'p_video_link': pVideoLink,
      'p_pdf': pPdf,
      'p_vendor_id': pVendorId,
      'p_cash_on_delivery': pCashOnDelivery,
      'p_free_shipping': pFreeShipping,
      'p_shipping_days': pShippingDays,
      'p_warranty': pWarranty,
      'p_warranty_number': pWarrantyNumber,
      'p_warranty_type': pWarrantyType,
      'p_warranty_desc': pWarrantyDesc,
      'p_guarantee': pGuarantee,
      'p_guarantee_number': pGuaranteeNumber,
      'p_guarantee_type': pGuaranteeType,
      'p_guarantee_desc': pGuaranteeDesc,
      'p_status': pStatus,
      'p_return': pReturn,
      'p_replace': pReplace,
      'p_refund_with_nonreturn': pRefundWithNonreturn,
      'p_brand_service_centre_replace': pBrandServiceCentreReplace,
      'p_nonreturn': pNonreturn,
      'p_meta_title': pMetaTitle,
      'p_meta_keyword': pMetaKeyword,
      'p_meta_desc': pMetaDesc,
      'p_updated_on': pUpdatedOn,
      'p_igst': pIgst,
      'p_sgst': pSgst,
      'p_cgst': pCgst,
      'p_ugst': pUgst,
      'p_admin_status': pAdminStatus,
      'p_re_order': pReOrder,
      'p_packaging': pPackaging,
      'p_estimate_pickup': pEstimatePickup,
      'p_mrp_price': pMrpPrice,
      'p_low_stock_alert': pLowStockAlert,
      'p_detail': pDetail,
      'p_discount': pDiscount,
      'p_gallery_images': pGalleryImages,
      'p_inactive_timestamp': pInactiveTimestamp,
      'p_admin_reason': pAdminReason,
      'variants': variants?.map((v) => {
        'p_id': v.pid,
        'pv_id': v.pvid,
        'pv_name': v.pvname,
        'pv_mrp_price': v.mrpPrice,
        'pv_discount': v.pvDiscount,
        'pv_discount_type': v.pvDiscountType,
        'pv_quantity': v.pvQuantity,
        'pv_low_stock': v.pvLowStock,
        'pv_selling_price': v.pvSellingPrice,
        'pv_main_image': v.pvMainImage,
        'pv_gallery_image': v.pvGalleryImages,
        'pv_youtube_link': v.pvYoutubeLink,
        'pv_status': v.pvStatus,
        'pv_created_on': v.pvCreatedOn,
        'pv_updated_on': v.pvUpdatedOn,
      }).toList(),
    };
  }
